...
export default function VerifyPage() {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6 pb-16">
      <Link href={`/${locale}/designations/cdip/registry`} className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
