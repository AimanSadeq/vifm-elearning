...
import { X, Save, Loader2, FolderPen } from 'lucide-react'
...
export function EditModuleDialog({ module: mod, onClose, onSuccess }: EditModuleDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error(result.error || 'Failed to update module')
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Rename the module or update its description</p>
            </div>
          </div>
