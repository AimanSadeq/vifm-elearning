...
(function() {
    ...
    window.ELEARN_DEMO_DATA = {
        ...
        courses: [
            { id: 'course-1', title: 'Financial Analysis Masterclass', slug: 'financial-analysis-masterclass', description: 'Comprehensive course covering DCF valuation, ratio analysis, and financial modeling for GCC markets.', thumbnail_url: '/courses/finance.jpg', category_id: 'cat-1', category: { name: 'Finance' }, instructor_id: 'demo-admin-001', instructor: { full_name: 'Demo Instructor' }, difficulty: 'intermediate', duration_hours: 12, price: 299, currency: 'USD', is_free: false, status: 'published', enrollment_count: 156, average_rating: 4.7, completion_rate: 78, modules_count: 4, lessons_count: 16, created_at: '2025-06-01T00:00:00Z' },
            { id: 'course-2', title: 'Risk Management & Basel III', slug: 'risk-management-basel-iii', description: 'Master risk management frameworks and Basel III compliance requirements for banking professionals.', thumbnail_url: '/courses/risk.jpg', category_id: 'cat-1', category: { name: 'Finance' }, instructor_id: 'demo-admin-001', instructor: { full_name: 'Demo Instructor' }, difficulty: 'advanced', duration_hours: 16, price: 399, currency: 'USD', is_free: false, status: 'published', enrollment_count: 89, average_rating: 4.8, completion_rate: 65, modules_count: 5, lessons_count: 20, created_at: '2025-07-15T00:00:00Z' },
            { id: 'course-3', title: 'Excel for Finance Professionals', slug: 'excel-for-finance', description: 'Advanced Excel techniques for financial modeling, data analysis, and reporting.', thumbnail_url: '/courses/excel.jpg', category_id: 'cat-2', category: { name: 'Data Analytics' }, instructor_id: 'demo-admin-001', instructor: { full_name: 'Demo Instructor' }, difficulty: 'beginner', duration_hours: 8, price: 0, currency: 'USD', is_free: true, status: 'published', enrollment_count: 324, average_rating: 4.5, completion_rate: 82, modules_count: 3, lessons_count: 12, created_at: '2025-05-01T00:00:00Z' },
            { id: 'course-4', title: 'Anti-Money Laundering (AML)', slug: 'anti-money-laundering', description: 'Comprehensive AML training covering KYC, transaction monitoring, and regulatory compliance.', thumbnail_url: '/courses/aml.jpg', category_id: 'cat-3', category: { name: 'Compliance' }, instructor_id: 'demo-admin-001', instructor: { full_name: 'Demo Instructor' }, difficulty: 'intermediate', duration_hours: 10, price: 249, currency: 'USD', is_free: false, status: 'published', enrollment_count: 201, average_rating: 4.6, completion_rate: 71, modules_count: 4, lessons_count: 15, created_at: '2025-08-01T00:00:00Z' },
            { id: 'course-5', title: 'Leadership in Banking', slug: 'leadership-in-banking', description: 'Develop executive leadership skills for senior banking professionals in the GCC region.', thumbnail_url: '/courses/leadership.jpg', category_id: 'cat-4', category: { name: 'Leadership' }, instructor_id: 'demo-admin-001', instructor: { full_name: 'Demo Instructor' }, difficulty: 'advanced', duration_hours: 14, price: 449, currency: 'USD', is_free: false, status: 'published', enrollment_count: 67, average_rating: 4.9, completion_rate: 58, modules_count: 5, lessons_count: 18, created_at: '2025-09-01T00:00:00Z' }
        ],
